/**
 * Playwright's documented seccomp profile for Chromium with its sandbox in
 * Docker, copied verbatim (as data) from
 * https://github.com/microsoft/playwright/blob/v1.63.0/utils/docker/seccomp_profile.json
 * (upstream file sha256 cc3e61cabda6bbc1e53e54d27ba4d55a9d3be829b6dd1a596f4a7b31b1cc7849).
 * It is Moby's default profile plus clone/setns/unshare for unprivileged user
 * namespaces. Oinko adds one rule at runtime; see `browserSeccompProfile`.
 */
export const PLAYWRIGHT_SECCOMP_PROFILE = {
  ...
  syscalls: [
    ...
    },
    {
      names: ['personality'],
      action: 'SCMP_ACT_ALLOW',
      args: [{ index: 0, value: 131072, valueTwo: 0, op: 'SCMP_CMP_EQ' }],
      comment: '',
      includes: {},
      excludes: {},
    },
    {
      names: ['personality'],
      action: 'SCMP_ACT_ALLOW',
      args: [{ index: 0, value: 131080, valueTwo: 0, op: 'SCMP_CMP_EQ' }],
      comment: '',
      includes: {},
      excludes: {},
    },
    {
      names: ['personality'],
      action: 'SCMP_ACT_ALLOW',
      args: [{ index: 0, value: 4294967295, valueTwo: 0, op: 'SCMP_CMP_EQ' }],
      comment: '',
      includes: {},
      excludes: {},
    },
    ...
    },
    {
      names: ['clone'],
      action: 'SCMP_ACT_ALLOW',
      args: [{ index: 1, value: 2114060288, valueTwo: 0, op: 'SCMP_CMP_MASKED_EQ' }],
