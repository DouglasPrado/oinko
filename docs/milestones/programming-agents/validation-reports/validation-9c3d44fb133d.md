# Relatório de validação — 9c3d44fb133d

Gerado por `node scripts/validation-suite.mjs` em 2026-09-24T16:41:24.658Z. Revisão `9c3d44fb133d97efd2e4488188a930e608332f2c` (código sem alterações locais; edições em docs/ não entram no teste). Node v26.8.1.
...
| --- | --- | ---: | ---: | ---: | ---: |
| pnpm build | ✅ passed | 1 | 0 | 0 | 16s |
| pnpm typecheck | ✅ passed | 1 | 0 | 0 | 10s |
| pnpm lint | ✅ passed | 1 | 0 | 0 | 15s |
| pnpm test | ✅ passed | 1 | 0 | 0 | 33s |
| core (SDK) | ⚠️ partial | 1660 | 0 | 1 | 5s |
| agent-runtime | ✅ passed | 138 | 0 | 0 | 2s |
| workspaces | ✅ passed | 12 | 0 | 0 | 2s |
| environments | ⚠️ partial | 182 | 0 | 71 | 11s |
| bots | ⚠️ partial | 52 | 0 | 4 | 7s |
| mcp-oinko | ⚠️ partial | 20 | 0 | 1 | 2s |
| dashboard (unit) | ✅ passed | 60 | 0 | 0 | 1s |
| gate: sem condicional por ID de piloto | ✅ passed | 1 | 0 | 0 | 0s |
| gate: links internos dos documentos do plano | ✅ passed | 1 | 0 | 0 | 0s |
| dashboard E2E (Playwright) | ✅ passed | 48 | 0 | 0 | 77s |
...
| Suíte | Resultado | Aprovados | Falhas | Não executados | Duração |
| --- | --- | ---: | ---: | ---: | ---: |
| Docker: environments (runner, falhas, browser) | ⚠️ partial | 69 | 0 | 1 | 114s |
| Docker: worker + runner + harness | ✅ passed | 6 | 0 | 0 | 43s |
| Docker: MCP Oinko (GitHub e worktree servida) | ✅ passed | 3 | 0 | 0 | 9s |
...
- `pnpm lint`
- `pnpm test`
- `pnpm exec vitest run --reporter=json --outputFile=/var/folders/nh/krqdl17x477_v5w2sqn66tb00000gn/T/oinko-validation-j8Cav0/core-SDK-.json (em packages/oinko)`
- `pnpm exec vitest run --reporter=json --outputFile=/var/folders/nh/krqdl17x477_v5w2sqn66tb00000gn/T/oinko-validation-j8Cav0/agent-runtime.json (em packages/agent-runtime)`
- `pnpm exec vitest run --reporter=json --outputFile=/var/folders/nh/krqdl17x477_v5w2sqn66tb00000gn/T/oinko-validation-j8Cav0/workspaces.json (em packages/workspaces)`
- `pnpm exec vitest run --reporter=json --outputFile=/var/folders/nh/krqdl17x477_v5w2sqn66tb00000gn/T/oinko-validation-j8Cav0/environments.json (em packages/environments)`
- `pnpm exec vitest run --reporter=json --outputFile=/var/folders/nh/krqdl17x477_v5w2sqn66tb00000gn/T/oinko-validation-j8Cav0/bots.json (em packages/bots)`
- `pnpm exec vitest run --reporter=json --outputFile=/var/folders/nh/krqdl17x477_v5w2sqn66tb00000gn/T/oinko-validation-j8Cav0/mcp-oinko.json (em packages/mcps/oinko)`
- `pnpm exec vitest run --reporter=json --outputFile=/var/folders/nh/krqdl17x477_v5w2sqn66tb00000gn/T/oinko-validation-j8Cav0/dashboard-unit-.json (em apps/dashboard)`
- `grep de comparações com "dev"`
- `verificação de 68 documentos`
- `pnpm exec vitest run tests/docker.test.ts tests/runner.e2e.test.ts tests/failures.e2e.test.ts tests/browser.e2e.test.ts tests/workspace.e2e.test.ts tests/publication-docker.e2e.test.ts --reporter=json --outputFile=/var/folders/nh/krqdl17x477_v5w2sqn66tb00000gn/T/oinko-validation-j8Cav0/Docker-environments-runner-falhas-browser-.json (em packages/environments)`
- `pnpm exec vitest run tests/programming.e2e.test.ts tests/evaluation.e2e.test.ts tests/programming.test.ts --reporter=json --outputFile=/var/folders/nh/krqdl17x477_v5w2sqn66tb00000gn/T/oinko-validation-j8Cav0/Docker-worker-runner-harness.json (em packages/bots)`
- `pnpm exec vitest run tests/runtime.test.ts --reporter=json --outputFile=/var/folders/nh/krqdl17x477_v5w2sqn66tb00000gn/T/oinko-validation-j8Cav0/Docker-MCP-Oinko-GitHub-e-worktree-servida-.json (em packages/mcps/oinko)`
