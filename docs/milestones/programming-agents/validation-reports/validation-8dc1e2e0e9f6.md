# Relatório de validação — 8dc1e2e0e9f6

Gerado por `node scripts/validation-suite.mjs` em 2026-09-24T16:52:46.966Z. Revisão `8dc1e2e0e9f665b9469a57fe35e6db34713357d3` (código sem alterações locais; edições em docs/ não entram no teste). Node v26.8.1.
...
| agent-runtime | ✅ passed | 139 | 0 | 0 | 2s |
| workspaces | ✅ passed | 12 | 0 | 0 | 1s |
...
| dashboard E2E (Playwright) | ✅ passed | 49 | 0 | 0 | 82s |
...
| Suíte | Resultado | Aprovados | Falhas | Não executados | Duração |
| --- | --- | ---: | ---: | ---: | ---: |
| Docker: environments (runner, falhas, browser) | ⚠️ partial | 69 | 0 | 1 | 115s |
| Docker: worker + runner + harness | ✅ passed | 6 | 0 | 0 | 42s |
| Docker: MCP Oinko (GitHub e worktree servida) | ✅ passed | 3 | 0 | 0 | 8s |
...
- `pnpm lint`
- `pnpm test`
- `pnpm exec vitest run --reporter=json --outputFile=/var/folders/nh/krqdl17x477_v5w2sqn66tb00000gn/T/oinko-validation-hFrUqc/core-SDK-.json (em packages/oinko)`
- `pnpm exec vitest run --reporter=json --outputFile=/var/folders/nh/krqdl17x477_v5w2sqn66tb00000gn/T/oinko-validation-hFrUqc/agent-runtime.json (em packages/agent-runtime)`
- `pnpm exec vitest run --reporter=json --outputFile=/var/folders/nh/krqdl17x477_v5w2sqn66tb00000gn/T/oinko-validation-hFrUqc/workspaces.json (em packages/workspaces)`
- `pnpm exec vitest run --reporter=json --outputFile=/var/folders/nh/krqdl17x477_v5w2sqn66tb00000gn/T/oinko-validation-hFrUqc/environments.json (em packages/environments)`
- `pnpm exec vitest run --reporter=json --outputFile=/var/folders/nh/krqdl17x477_v5w2sqn66tb00000gn/T/oinko-validation-hFrUqc/bots.json (em packages/bots)`
- `pnpm exec vitest run --reporter=json --outputFile=/var/folders/nh/krqdl17x477_v5w2sqn66tb00000gn/T/oinko-validation-hFrUqc/mcp-oinko.json (em packages/mcps/oinko)`
- `pnpm exec vitest run --reporter=json --outputFile=/var/folders/nh/krqdl17x477_v5w2sqn66tb00000gn/T/oinko-validation-hFrUqc/dashboard-unit-.json (em apps/dashboard)`
- `grep de comparações com "dev"`
- `verificação de 69 documentos`
- `pnpm exec vitest run tests/docker.test.ts tests/runner.e2e.test.ts tests/failures.e2e.test.ts tests/browser.e2e.test.ts tests/workspace.e2e.test.ts tests/publication-docker.e2e.test.ts --reporter=json --outputFile=/var/folders/nh/krqdl17x477_v5w2sqn66tb00000gn/T/oinko-validation-hFrUqc/Docker-environments-runner-falhas-browser-.json (em packages/environments)`
- `pnpm exec vitest run tests/programming.e2e.test.ts tests/evaluation.e2e.test.ts tests/programming.test.ts --reporter=json --outputFile=/var/folders/nh/krqdl17x477_v5w2sqn66tb00000gn/T/oinko-validation-hFrUqc/Docker-worker-runner-harness.json (em packages/bots)`
- `pnpm exec vitest run tests/runtime.test.ts --reporter=json --outputFile=/var/folders/nh/krqdl17x477_v5w2sqn66tb00000gn/T/oinko-validation-hFrUqc/Docker-MCP-Oinko-GitHub-e-worktree-servida-.json (em packages/mcps/oinko)`
