# Relatório de validação — be30ad61fc88

Gerado por `node scripts/validation-suite.mjs` em 2026-09-24T15:17:02.732Z. Revisão `be30ad61fc88436b0f9438aa1099075fa605b26c`. Node v26.8.1.
...
| dashboard E2E (Playwright) | ❌ failed | 38 | 1 | 0 | 45s |
...
- `pnpm lint`
- `pnpm test`
- `pnpm exec vitest run --reporter=json --outputFile=/var/folders/nh/krqdl17x477_v5w2sqn66tb00000gn/T/oinko-validation-zAuO10/core-SDK-.json (em packages/oinko)`
- `pnpm exec vitest run --reporter=json --outputFile=/var/folders/nh/krqdl17x477_v5w2sqn66tb00000gn/T/oinko-validation-zAuO10/agent-runtime.json (em packages/agent-runtime)`
- `pnpm exec vitest run --reporter=json --outputFile=/var/folders/nh/krqdl17x477_v5w2sqn66tb00000gn/T/oinko-validation-zAuO10/workspaces.json (em packages/workspaces)`
- `pnpm exec vitest run --reporter=json --outputFile=/var/folders/nh/krqdl17x477_v5w2sqn66tb00000gn/T/oinko-validation-zAuO10/environments.json (em packages/environments)`
- `pnpm exec vitest run --reporter=json --outputFile=/var/folders/nh/krqdl17x477_v5w2sqn66tb00000gn/T/oinko-validation-zAuO10/bots.json (em packages/bots)`
- `pnpm exec vitest run --reporter=json --outputFile=/var/folders/nh/krqdl17x477_v5w2sqn66tb00000gn/T/oinko-validation-zAuO10/mcp-oinko.json (em packages/mcps/oinko)`
- `pnpm exec vitest run --reporter=json --outputFile=/var/folders/nh/krqdl17x477_v5w2sqn66tb00000gn/T/oinko-validation-zAuO10/dashboard-unit-.json (em apps/dashboard)`
- `grep de comparações com "dev"`
- `pnpm exec vitest run tests/docker.test.ts tests/runner.e2e.test.ts tests/failures.e2e.test.ts tests/browser.e2e.test.ts tests/workspace.e2e.test.ts tests/publication-docker.e2e.test.ts --reporter=json --outputFile=/var/folders/nh/krqdl17x477_v5w2sqn66tb00000gn/T/oinko-validation-zAuO10/Docker-environments-runner-falhas-browser-.json (em packages/environments)`
- `pnpm exec vitest run tests/programming.e2e.test.ts tests/evaluation.e2e.test.ts --reporter=json --outputFile=/var/folders/nh/krqdl17x477_v5w2sqn66tb00000gn/T/oinko-validation-zAuO10/Docker-worker-runner-harness.json (em packages/bots)`
